...
const PLUGIN_DSN = 'plugin::strapi-encryptable-field.strapi-encryptable-field';
  ...
  getWelcomeMessage() {
    ...
    getFields(fields: object, roles?: any[]): string[] {
      ...
      for (const attribute in fields) {
        if (
          Object.prototype.hasOwnProperty.call(fields, attribute) &&
          Object.prototype.hasOwnProperty.call(fields[attribute], 'customField') &&
          fields[attribute].customField === PLUGIN_DSN
        ) {
          if (roles &&
            Object.prototype.hasOwnProperty.call(fields[attribute], 'options') &&
            Object.prototype.hasOwnProperty.call(fields[attribute].options, 'roles')
          ) {
